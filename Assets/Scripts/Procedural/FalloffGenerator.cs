...
namespace TilePuzzle.Procedural
{
    public class FalloffGenerator : Singleton<FalloffGenerator>
    {
        ...
        {
            float maxX = (width - 1) * HexagonTileObject.TileSize + (HexagonTileObject.TileSize / 2);
            float maxY = (height - 1) * HexagonTileObject.TileSize * Mathf.Sin(Mathf.PI / 3);
            ...
            falloffMap.SetFloat("hexagonSize", HexagonTileObject.TileSize);
